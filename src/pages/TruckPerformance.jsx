...
const trucksData = [
  ...
  },
  {
    ...
    Lastest_Audit_Open_From: "System",
    history: [
      {
        Def_ID: "AUDIT-1151",
        Reg_No: "HRAB1234",
        Vendor_Code: "K022",
        Created_Date: "10-Jun-2025",
        Status: "Red",
      },
    ],
  },
  ...
  },
  {
    ...
    Lastest_Audit_Open_From: "2 days",
    history: [],
  },
  {
    TruckNo: "HR77TT1122",
          ...
          <table className="min-w-full bg-white rounded shadow overflow-hidden text-sm text-left">
            <thead className="bg-gray-100 text-gray-700">
              <tr>
                ...
                <th className="px-4 py-2">Total Audits</th>
                <th className="px-4 py-2">Avg Submissions</th>
                <th className="px-4 py-2">Status</th>
                <th className="px-4 py-2">Last Audit Open</th>
